...
4. Output: `dist/Codentis-Setup-1.3.4.exe`
...
3. Output: `dist/Codentis-1.3.4-arm64.pkg` or `dist/Codentis-1.3.4-intel.pkg`
...
3. Output: `dist/codentis_1.3.4_amd64.deb`
...
// macOS
<a href="/Codentis-1.3.4-arm64.pkg" download>
  Download Installer (Apple Silicon)
</a>

// Linux
<a href="/codentis_1.3.4_amd64.deb" download>
