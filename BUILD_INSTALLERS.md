...
4. Output: `dist/Codentis-Setup-1.5.1.exe`
...
3. Output: `dist/Codentis-1.5.1-arm64.pkg` or `dist/Codentis-1.5.1-intel.pkg`
...
3. Output: `dist/codentis_1.5.1_amd64.deb`
...
// macOS
<a href="/Codentis-1.5.1-arm64.pkg" download>
  Download Installer (Apple Silicon)
</a>

// Linux
<a href="/codentis_1.5.1_amd64.deb" download>
