...
4. Output: `dist/Codentis-Setup-1.5.2.exe`
...
3. Output: `dist/Codentis-1.5.2-arm64.pkg` or `dist/Codentis-1.5.2-intel.pkg`
...
3. Output: `dist/codentis_1.5.2_amd64.deb`
...
### Windows:
```bash
# Download and run Codentis-Setup-1.5.2.exe
...
sudo installer -pkg Codentis-1.5.2-arm64.pkg -target /
```

### Linux (Debian/Ubuntu):
```bash
# Download the .deb file
sudo dpkg -i codentis_1.5.2_amd64.deb
```
...
// macOS
<a href="/Codentis-1.5.2-arm64.pkg" download>
  Download Installer (Apple Silicon)
</a>

// Linux
<a href="/codentis_1.5.2_amd64.deb" download>
