...
### Fixed
- Production website now correctly shows download URLs with proper version numbers
- Build artifacts now have correct version numbers in filenames
- Added .env.production file for consistent production deployments
