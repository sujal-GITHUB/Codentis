...
# Output: dist/Codentis-Setup-1.5.2.exe
```
...
# Output: dist/Codentis-1.5.2-arm64.pkg
```
...
# Output: dist/codentis_1.5.2_amd64.deb
```
...
3. Fill in:
   - **Tag**: v1.5.2
   - **Title**: Codentis v1.5.2
   - **Description**: Copy from CHANGELOG.md
   - **Attach files**:
     - `Codentis-Setup-1.5.2.exe` (Windows)
     - `Codentis-1.5.2-arm64.pkg` (macOS)
     - `codentis_1.5.2_amd64.deb` (Linux)
...
```tsx
<a href="/Codentis-Setup-1.5.2.exe" download>
...
```bash
cp dist/Codentis-Setup-1.5.2.exe website/public/
```
...
```bash
git checkout -b hotfix/0.1.2 v1.5.2
```

2. Fix the bug and release v1.5.2 following the same process
