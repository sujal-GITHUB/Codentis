...
# Output: dist/Codentis-Setup-1.4.3.exe
```
...
# Output: dist/Codentis-1.4.3-arm64.pkg
```
...
# Output: dist/codentis_1.4.3_amd64.deb
```
...
3. Fill in:
   - **Tag**: v1.4.3
   - **Title**: Codentis v1.4.3
   - **Description**: Copy from CHANGELOG.md
   - **Attach files**:
     - `Codentis-Setup-1.4.3.exe` (Windows)
     - `Codentis-1.4.3-arm64.pkg` (macOS)
...
```tsx
<a href="/Codentis-Setup-1.4.3.exe" download>
...
```bash
cp dist/Codentis-Setup-1.4.3.exe website/public/
```
...
```bash
git checkout -b hotfix/0.1.2 v1.4.3
```

2. Fix the bug and release v1.4.3 following the same process
