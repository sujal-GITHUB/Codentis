...
# Output: dist/Codentis-Setup-0.1.1.exe
```
...
# Output: dist/Codentis-0.1.1-arm64.pkg
```
...
# Output: dist/codentis_0.1.1_amd64.deb
```
...
3. Fill in:
   - **Tag**: v0.1.1
   - **Title**: Codentis v0.1.1
   - **Description**: Copy from CHANGELOG.md
   - **Attach files**:
     - `Codentis-Setup-0.1.1.exe` (Windows)
     - `Codentis-0.1.1-arm64.pkg` (macOS)
     - `codentis_0.1.1_amd64.deb` (Linux)
...
```tsx
<a href="/Codentis-Setup-0.1.1.exe" download>
...
```bash
cp dist/Codentis-Setup-0.1.1.exe website/public/
```
...
2. Fix the bug and release v0.1.2 following the same process
