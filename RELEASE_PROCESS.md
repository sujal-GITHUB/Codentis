...
# Output: dist/Codentis-Setup-1.5.1.exe
```
...
# Output: dist/Codentis-1.5.1-arm64.pkg
```
...
# Output: dist/codentis_1.5.1_amd64.deb
```
...
3. Fill in:
   - **Tag**: v1.5.1
   - **Title**: Codentis v1.5.1
   - **Description**: Copy from CHANGELOG.md
   - **Attach files**:
     - `Codentis-Setup-1.5.1.exe` (Windows)
     - `Codentis-1.5.1-arm64.pkg` (macOS)
...
```tsx
<a href="/Codentis-Setup-1.5.1.exe" download>
...
```bash
cp dist/Codentis-Setup-1.5.1.exe website/public/
```
...
```bash
git checkout -b hotfix/0.1.2 v1.5.1
```

2. Fix the bug and release v1.5.1 following the same process
