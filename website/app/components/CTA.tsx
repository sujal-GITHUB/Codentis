        ...
        <section className="py-24 sm:py-32 sm:py-40 relative overflow-hidden">
            ...
            <div className="max-w-[1120px] mx-auto px-6 relative z-[2] text-center">
                ...
                <a
                    ...
                    className="inline-flex items-center gap-2.5 px-8 py-3.5 bg-white text-black font-semibold text-[0.85rem] sm:text-[0.9rem] rounded-full hover:shadow-[0_0_40px_rgba(6,182,212,0.25)] hover:-translate-y-0.5 transition-all duration-400 active:scale-95"
                >
