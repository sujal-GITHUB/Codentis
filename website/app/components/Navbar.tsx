            ...
            >
                ...
                <div className="flex items-center gap-1 sm:gap-1.5">
                    ...
                    <a
                        ...
                        className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3.5 py-1.5 rounded-full text-[10px] sm:text-[0.8rem] font-medium text-zinc-300 bg-white/[0.06] hover:bg-white/[0.12] hover:text-white transition-all duration-200"
                    >
                        <svg width="11" height="11" className="sm:w-[13px] sm:h-[13px]" viewBox="0 0 24 24" fill="currentColor">
