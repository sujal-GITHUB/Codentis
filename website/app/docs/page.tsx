                  ...
                  <div className="p-6 border border-white/[0.05] bg-bg-2 rounded-xl">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-[13px] sm:text-sm text-zinc-400">Download the Codentis-Setup-{'1.3.4'}.exe file from the link above.</p>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="bg-black/50 p-3 rounded-lg font-mono text-sm">
                          ...
                          <div className="text-cyan-400 mt-1">Codentis v1.3.4</div>
                        </div>
                      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 border border-white/[0.05] bg-bg-2 rounded-xl">
                    ...
                    <div className="bg-black/50 p-3 rounded-lg font-mono text-sm mb-3">
                      ...
                      <div className="text-zinc-400">│ Codentis v1.3.4                                              │</div>
